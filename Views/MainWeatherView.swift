                    ...
                    MainWeatherViewLight(network: network)
                        ...
                        .toolbar {
                            ToolbarItem(placement: .navigationBarLeading) {
                                ...
                                if  Purchases.shared.cachedCustomerInfo?.entitlements["AddLocation"]?.isActive == true {
                                    NavigationLink(destination: LocationViewLight(networking: self.network)){
                                        Text("Locations")
                                    }
                                }
                                else {
                                    NavigationLink(destination: SubscriptionOptionsViewLight()) {
                                        Text("Locations")
                                    }
                                }
                    ...
                    MainWeatherViewDark(network: network)
                        ...
                        .toolbar {
                            ToolbarItem(placement: .navigationBarLeading) {
                                ...
                                if  Purchases.shared.cachedCustomerInfo?.entitlements["AddLocation"]?.isActive == true {
                                    NavigationLink(destination: LocationViewDark(networking: self.network)){
                                        Text("Locations")
                                    }
                                }
                                else {
                                    NavigationLink(destination: SubscriptionOptionsViewDark()) {
                                        Text("Locations")
                                    }
                                }
